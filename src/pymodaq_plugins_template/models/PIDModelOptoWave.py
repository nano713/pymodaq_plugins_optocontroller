...
class PIDModelOptoPower(PIDModelGeneric):
    ...
    actuators_name = ['Zaber']  # names of actuator's control modules involved in the PID
    detectors_name = ['ThorlabsCCS']  # names of detector's control modules involved in the PID
